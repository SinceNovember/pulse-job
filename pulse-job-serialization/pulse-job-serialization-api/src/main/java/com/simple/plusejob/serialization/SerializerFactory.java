...
import com.simple.pulsejob.common.util.collection.ByteObjectHashMap;
import com.simple.pulsejob.common.util.collection.ByteObjectMap;
...
public final class SerializerFactory {
    ...
    static {
        Map<String, Serializer> serializerMap = SpringContextUtil.getBeansOfType(Serializer.class);
        for (Serializer s : serializerMap.values()) {
