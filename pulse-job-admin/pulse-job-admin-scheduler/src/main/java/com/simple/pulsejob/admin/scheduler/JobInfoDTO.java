...
public class JobInfoDTO {
    ...
    /** 分发类型 */
    @Builder.Default
    private Dispatcher.Type dispatchType = Dispatcher.Type.ROUND;

    /** 负载均衡类型 */
    @Builder.Default
    private LoadBalancer.Type loadBalanceType = LoadBalancer.Type.RANDOM;
    ...
    public static JobInfoDTO from(JobInfo jobInfo) {
        ...
        return JobInfoDTO.builder()
                ...
                .executorName(jobInfo.getExecutorName())
                .scheduleType(ScheduleStrategy.Type.from(jobInfo.getScheduleType()))
    ...
    public static JobInfoDTO ofTrigger(String executorName, Long jobId, Long executorId,
        ...
        return JobInfoDTO.builder()
                ...
                .jobParams(jobParams)
                .scheduleType(ScheduleStrategy.Type.API)
                .build();
    }
}
