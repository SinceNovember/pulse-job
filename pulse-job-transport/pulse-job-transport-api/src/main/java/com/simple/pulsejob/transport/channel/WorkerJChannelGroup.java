 ...
 */
package com.simple.pulsejob.transport.channel;

import java.util.concurrent.ConcurrentHashMap;
import java.util.concurrent.ConcurrentMap;
import java.util.concurrent.atomic.AtomicInteger;
import com.simple.pulsejob.common.util.Maps;
import com.simple.pulsejob.transport.WorkerInfo;
 ...
 * @author jiachun.fjc
 */
public class WorkerJChannelGroup {

    // key: handler名称; value: 提供服务的节点列表(group list)
    ...
    public CopyOnWriteGroupList find(WorkerInfo directory) {
