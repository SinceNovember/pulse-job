 ...
 */
package com.simple.pulsejob.transport.netty.alloc;
...
/**
 *
 *  Netty 的自适应缓冲区分配器，能智能调整 ByteBuf 大小，提升内存利用率并减少不必要的扩容和收缩,并让下一次分配内存的时候提供一个合适的大小
 *
 */
public class AdaptiveOutputBufAllocator {
    ...
    private static final class HandleImpl implements Handle {
        ...
        private int index;                          // 记录当前缓冲区大小的索引
        private volatile int nextAllocateBufSize;   // 下次分配的缓冲区大小
        private boolean decreaseNow;                 // 是否需要减少缓冲区大小
